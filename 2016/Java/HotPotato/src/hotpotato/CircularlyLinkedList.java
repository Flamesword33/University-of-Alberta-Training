/*
 * Copyright 2014, Michael T. Goodrich, 
 ...
 * @param <E>
 */
public class CircularlyLinkedList<E> extends HotPotato{
  //---------------- nested Node class ----------------
  /**
...
//  public void switch_places(String place_1, String place_2){//part 4
//      Node<E> pointer_1;
//      Node<E> pointer_2;
//      Node<E> pointer_3;
//      Node<E> pointer_4;
...
//      }//if
//      else if(size == 3){
//          pointer_1 = tail.getNext().getNext();
//          tail.getNext().setNext(tail);
//          pointer_1.setNext(tail.getNext());
//          tail.setNext(pointer_1);   
//          ////////////////////////////////////////////////
//          //STILL NEEDS TO BE REORGANIZED FOR CONDITIONS//
//          //  RELATING TO WHICH VARIBLE SWITCHES WHICH  //
//          ////////////////////////////////////////////////
//      }//else if 
//      else{
//          if(person_1 == (person_2 + 1) || person_1 == (person_2 - 1)){
//              //////////////////////////////
//              //STILL IN THE DRAWING BOARD//
//              //////////////////////////////
//          }//second if checing if points are next to each other
//          else{
//              //needs two for loops to place markers before and on
//              //place 1 and 2
///**
// *   --   --   --   --   --
// *  |x1|>|  |>|x2|>|  |>|  |>
...
// */
//              
//          }//second if going into general case
//      }//else
//      
//    }//switch places
